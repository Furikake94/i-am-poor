import sqlite3, tkinter, sys, cmd
    ...
    def do_view(self, line):
        ...
        while True:
            ...
            #for attempt in range(tries):
                    ...
                    #while True:
                            #try:
                                #category = str(input('Select a category to view or leave blank'))
                                #break
                            #except:
                                #pass
...
if __name__ == "__main__":
    Expensetracker().cmdloop('''    Welcome to poorness-meter, a simple python shell
    to track and investigate how poor you actually are!
    ==== available commands ======
    view | log | delete | help | quit''')
